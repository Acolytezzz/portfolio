...
export default function WhatIdo() {
  return (
    <div className="flex flex-col items-center my-12 px-12">
      ...
      <div className="flex justify-center mb-8">
        <img
          src={webDev}
          alt="webDevImg"
          className="w-[49%] rounded-3xl my-2"
        />
        <div className="w-[49%] m-2 p-4">
          ...
          <p className="flex items-start text-lg dark:text-white font-Poppins font-medium leading-8">
            <GiStarSkull className="text-3xl mr-2" /> Making modern, simple and
            elegant websites for projects
          </p>
          <p className="flex items-start text-lg dark:text-white font-Poppins font-medium leading-8">
            <GiStarSkull className="text-3xl mr-2" /> Designing clean, efficient
            code for seamless user experiences
          </p>
          <p className="flex items-start text-lg dark:text-white font-Poppins font-medium leading-8">
            <GiStarSkull className="text-3xl mr-2" /> Continuous integration and
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-[49%] m-2 p-4">
          ...
          <p className="flex items-start text-lg dark:text-white font-Poppins font-medium leading-8">
            <GiStarSkull className="text-3xl mr-2" /> Ensuring smooth navigation
            and cohesive interaction flows
          </p>
        </div>
      </div>
    </div>
